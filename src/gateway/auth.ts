...
export type ResolvedGatewayAuthMode = "token" | "password" | "approval";
...
export type ResolvedGatewayAuth = {
  ...
  approval?: GatewayApprovalConfig;
};

export type GatewayAuthResult = {
  ok: boolean;
  method?: "token" | "password" | "tailscale" | "device-token" | "approval";
  user?: string;
  reason?: string;
};
