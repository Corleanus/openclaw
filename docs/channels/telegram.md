...
- `channels.telegram.reactionLevel`: Controls agent's reaction capability
  ...
  - `"minimal"` — agent can react sparingly (guideline: 1 per 5-10 exchanges) (default)
...
- Upgrade to an OpenClaw build that normalizes abort signals (and keep Node on the supported baseline: Node 22+).
