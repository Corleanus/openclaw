...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Claude Opus** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.openclaw.ai/start/onboarding).
...
Note: signed builds required for macOS permissions to stick across rebuilds (see https://docs.openclaw.ai/platforms/mac/permissions).
